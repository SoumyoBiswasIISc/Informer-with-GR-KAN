...
from data.data_loader import Dataset_ETT_hour, Dataset_ETT_minute, Dataset_Custom, Dataset_Pred
from exp.exp_basic import Exp_Basic
from models.model import Informer, InformerStack  # === GR-KAN modifications are inside models/model.py ===
...
class Exp_Informer(Exp_Basic):
    ...
    def _get_data(self, flag, train_scaler=None):
        ...
        data_set = Data(
            ...
            cols=args.cols,
            scale=True,
            train_scaler=train_scaler,  # === Agriculture-specific: pass scaler ===
        )
        data_set.__read_data__()  # === Agriculture-specific: explicitly load data ===
        print(flag, len(data_set))
    ...
    def train(self, setting):
        train_data, train_loader = self._get_data(flag="train")
        vali_data, vali_loader = self._get_data(flag="val", train_scaler=train_data.scaler)
        test_data, test_loader = self._get_data(flag="test", train_scaler=train_data.scaler)
